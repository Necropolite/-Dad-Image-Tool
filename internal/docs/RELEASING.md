...
5. build the PyInstaller onedir application with the horse icon and bundled runtime dependencies;
...
7. Verify the release tag exists and all release assets are present.
